...
class TestDataLoader(BaseTestCase):
    ...
    def test_dataloader(self):
        ...
        print('content shape:', len(content_dataset))
        print('style shape:', len(style_dataset))
        print('synth shape:', len(synth_dataset))
        print("loader shape", len(train_loader))
        print("hehe loader shape", len(DataLoader(content_dataset)))

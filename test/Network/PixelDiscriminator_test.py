...
class TestPixelDiscriminator(BaseTestCase):
    def setUp(self):
        self.args = DotDict({
            "image_size": 256,
            "batch_size": 1,
        ...
        self.model = PixelDiscriminator(self.args.in_channel_num, channel_base_num=self.args.channel_base_num)
    ...
    def test_pixel_discriminator(self):
